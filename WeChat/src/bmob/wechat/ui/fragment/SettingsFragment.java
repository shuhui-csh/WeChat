 ...
 * @author bright.van,ljh.liu
 * @date 2014-10-31 21:00
 */

public class SettingsFragment extends Fragment implements OnClickListener {
	// 个人资料，接收消息，声音，震动等四个列表项的父容器，均为相对布局.rl是相对布局的简称
	RelativeLayout rl_info, rl_switch_notification, rl_switch_voice,
			rl_switch_vibrate;
...
//		 firstOptionPreferenceUtil = mApplication.getSpUtil();
		firstOptionPreferenceUtil = new SharePreferenceUtil(getActivity(),
				"first_options");
	}
	...
	private void initView(View view) {
		...
		// 接受新消息通知列表项
		rl_switch_notification = (RelativeLayout) view
				.findViewById(R.id.rl_switch_notification);
		// 声音列表项
		rl_switch_voice = (RelativeLayout) view
				.findViewById(R.id.rl_switch_voice);
		// 震动列表项
		rl_switch_vibrate = (RelativeLayout) view
		...
		// 初始化所有列表项对应的图片等等
		iv_open_notification = (ImageView) view
				.findViewById(R.id.iv_open_notification);
		iv_close_notification = (ImageView) view
